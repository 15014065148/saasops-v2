...
import com.eveb.saasops.modules.member.entity.MbrCollect;
import com.eveb.saasops.modules.member.service.MbrCollectService;
...
@Api(value = "collect", description = "会员收藏")
