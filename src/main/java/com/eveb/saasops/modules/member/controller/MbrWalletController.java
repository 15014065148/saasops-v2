...
@Api(value = "MbrWallet", description = "会员钱包")
public class MbrWalletController {
    @Autowired
	...
	public R walletSubtract(@RequestBody MbrBillDetail record) {
		...
		//mbrWallet.setAccountId(record.getAccountId());
		mbrWallet.setBalance(record.getAmount());
		//mbrWallet.setDepotId(Constants.SYS_DEPOT_ID);
