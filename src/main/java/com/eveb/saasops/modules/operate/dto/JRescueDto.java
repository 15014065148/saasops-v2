...
@Getter
@Setter
@ApiModel(value = "PreferentialDto", description = "救援金")
public class JRescueDto {
    ...
    @ApiModelProperty(value = "账户总余额 ≤ totalMoney（为空则不限制）")
    private BigDecimal totalMoney;

    @ApiModelProperty(value = "活动规则")
    private List<RescueRuleDto> ruleDtos;
}
