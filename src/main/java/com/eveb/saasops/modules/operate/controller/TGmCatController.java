...
import com.eveb.saasops.modules.operate.service.TGmCatService;
import com.eveb.saasops.modules.operate.service.TGmDepotcatService;
...
public class TGmCatController {
    ...
    public R listCatDepot(@RequestParam("catId") @NotNull Integer catId) {
        List<TGmDepotcat> tGmCats=tGmDepotcatService.catDepotList(catId);
    ...
    public void exportExcel(@ModelAttribute TGmDepot tGmDepot,HttpServletResponse response) {
    	...
    	tGmCatService.exportExcel(tGmDepot,response);
    }
}
