...
public class OkHttpUtils {
 ...
 /*   public static String postJson(String url, Object obj) {
        return execute(OkHttp.builder().url(url).method(POST).data(JSON.toJSONString(obj)).mediaType(APPLICATION_JSON).build());
    }*/
    ...
    public static Request getRequest(String url, Object obj) {
        return new Request.Builder().url(url).post(RequestBody.create(MEDIA_TYPE_MARKDOWN, JSON.toJSONString(obj))).build();
    }
